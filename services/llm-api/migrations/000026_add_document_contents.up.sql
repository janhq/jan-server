...
CREATE INDEX idx_document_contents_media_object_id ON llm_api.document_contents(media_object_id);
CREATE INDEX idx_document_contents_user_id ON llm_api.document_contents(user_id);
CREATE INDEX idx_document_contents_status ON llm_api.document_contents(processing_status);
...
CREATE INDEX idx_project_files_project_id ON llm_api.project_files(project_id);
CREATE INDEX idx_project_files_deleted_at ON llm_api.project_files(deleted_at);
CREATE INDEX idx_project_files_display_order ON llm_api.project_files(project_id, display_order);
