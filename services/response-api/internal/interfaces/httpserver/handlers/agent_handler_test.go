...
func TestAgentHandler_List(t *testing.T) {
	...
	// Should return default agents (deep_research, doc_generator, pdf_generator, spreadsheet_generator)
	...
	assert.True(t, agentTypes["doc_generator"], "doc_generator agent should be present")
}
...
func TestAgentHandler_GetCapabilities(t *testing.T) {
	...
	assert.True(t, agentTypes["doc_generator"], "doc_generator should be in capabilities")
}
