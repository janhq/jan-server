...
type Conversation struct {
	...
	UserID          string                    `json:"-"` // User identifier (JWT subject or user ID string)
...
func NewConversationWithProject(publicID string, userID string, title *string, metadata map[string]string, projectID *uint) *Conversation {
	now := time.Now()
