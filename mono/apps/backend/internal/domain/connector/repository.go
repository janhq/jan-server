...
type Repository interface {
	...
	FindByUserAndType(ctx context.Context, userID string, connectorType ConnectorType) (*Connection, error)
	FindAllByUser(ctx context.Context, userID string) ([]*Connection, error)
	Delete(ctx context.Context, userID string, connectorType ConnectorType) error
	...
	FindAuditLogsByUser(ctx context.Context, userID string, limit int) ([]*AuditLog, error)
}
