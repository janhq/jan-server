...
type Repository interface {
	FindByUserID(ctx context.Context, userID string) (*UserSettings, error)
...
func (s *Service) GetOrCreateSettings(ctx context.Context, userID string) (*UserSettings, error) {
...
func (s *Service) UpdateSettings(ctx context.Context, userID string, req UpdateRequest) (*UserSettings, error) {
