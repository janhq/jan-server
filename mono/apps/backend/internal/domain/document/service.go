...
func (s *DocumentService) GetDocumentContentByMediaObjectID(ctx context.Context, mediaObjectID string, userID string) (*DocumentContent, error) {
...
func (s *DocumentService) ListDocumentContents(ctx context.Context, userID string, pagination *query.Pagination) ([]*DocumentContent, int64, error) {
