...
func (s *ShareService) ListSharesByConversation(ctx context.Context, conversationID uint, ownerUserID string, includeRevoked bool) ([]*Share, error) {
	// Verify ownership
...
func (s *ShareService) ListUserShares(ctx context.Context, ownerUserID string, includeRevoked bool) ([]*Share, error) {
	filter := ShareFilter{
...
func (s *ShareService) RevokeShare(ctx context.Context, sharePublicID string, ownerUserID string) error {
