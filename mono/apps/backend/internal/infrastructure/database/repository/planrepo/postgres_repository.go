...
import (
	...
	domain "jan-server/mono/apps/backend/internal/domain/plan"
	"jan-server/mono/apps/backend/internal/domain/status"
...
func (r *PostgresRepository) List(ctx context.Context, filter *domain.Filter) ([]*domain.Plan, int64, error) {
	query := r.db.WithContext(ctx).Model(&dbschema.Plan{}).Preload("Response")
...
func (r *PostgresRepository) Delete(ctx context.Context, id string) error {
	if err := r.db.WithContext(ctx).
		Where("public_id = ?", id).
		Delete(&dbschema.Plan{}).Error; err != nil {
		return platformerrors.NewError(
			ctx,
			platformerrors.LayerRepository,
			platformerrors.ErrorTypeDatabaseError,
...
func (r *PostgresRepository) ListTasksByPlanID(ctx context.Context, planID string) ([]*domain.Task, error) {
	...
	var entities []dbschema.PlanTask
	if err := r.db.WithContext(ctx).
...
func (r *PostgresRepository) ListStepsByTaskID(ctx context.Context, taskID string) ([]*domain.Step, error) {
	...
	var entities []dbschema.PlanStep
	if err := r.db.WithContext(ctx).
...
func (r *PostgresRepository) CreateStepDetail(ctx context.Context, detail *domain.StepDetail) error {
	...
	entity := &dbschema.PlanStepDetail{
		PublicID:   publicID,
		StepID:     step.ID,
...
func (r *PostgresRepository) ListDetailsByStepID(ctx context.Context, stepID string) ([]*domain.StepDetail, error) {
	...
	var entities []dbschema.PlanStepDetail
	if err := r.db.WithContext(ctx).
...
func mapPlanToEntity(plan *domain.Plan, responseID uint, currentTaskID, finalArtifactID *uint) (*dbschema.Plan, error) {
...
func mapPlanFromEntity(entity *dbschema.Plan) (*domain.Plan, error) {
	plan := &domain.Plan{
		ID:             entity.PublicID,
		Model:          entity.Model,
...
func mapPlanFromEntityWithDetails(entity *dbschema.Plan) (*domain.Plan, error) {
	plan, err := mapPlanFromEntity(entity)
	if err != nil {
		return nil, err
	}
...
func (r *PostgresRepository) resolveResponseID(ctx context.Context, publicID string) (uint, error) {
	...
	var response dbschema.Response
...
func (r *PostgresRepository) resolveArtifactID(ctx context.Context, publicID *string) (*uint, error) {
	...
	var artifact dbschema.Artifact
...
func (r *PostgresRepository) hydratePlanRefs(ctx context.Context, plan *domain.Plan, entity *dbschema.Plan) error {
...
func mapTaskToEntity(task *domain.Task, planID uint) *dbschema.PlanTask {
	return &dbschema.PlanTask{
		PublicID:     task.ID,
		PlanID:       planID,
...
func mapTaskFromEntity(entity *dbschema.PlanTask, planID string) *domain.Task {
	return &domain.Task{
		ID:           entity.PublicID,
		PlanID:       planID,
...
func mapStepToEntity(step *domain.Step, taskID uint) *dbschema.PlanStep {
...
func mapStepFromEntity(entity *dbschema.PlanStep, taskID string) *domain.Step {
	step := &domain.Step{
		ID:            entity.PublicID,
		TaskID:        taskID,
		Sequence:      entity.Sequence,
...
func mapDetailFromEntity(entity *dbschema.PlanStepDetail, stepID string) *domain.StepDetail {
