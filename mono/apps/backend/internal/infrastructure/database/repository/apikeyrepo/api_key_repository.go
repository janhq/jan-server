...
func (r *Repository) ListByUser(ctx context.Context, userID string) ([]apikey.APIKey, error) {
...
func (r *Repository) ListUserKeys(ctx context.Context, userID string) ([]apikey.APIKey, error) {
	var models []dbschema.APIKey
	if err := r.db.WithContext(ctx).
...
func (r *Repository) FindActiveSystemKey(ctx context.Context, userID string) (*apikey.APIKey, error) {
...
func (r *Repository) CountActiveByUser(ctx context.Context, userID string) (int64, error) {
	var count int64
	now := time.Now()
