...
func (repo *ProjectGormRepository) GetByPublicIDAndUserID(ctx context.Context, publicID string, userID string) (*project.Project, error) {
	var dbProject dbschema.Project
	err := repo.db.WithContext(ctx).
...
func (repo *ProjectGormRepository) GetByNameAndUserID(ctx context.Context, name string, userID string) (*project.Project, error) {
	var dbProject dbschema.Project
	err := repo.db.WithContext(ctx).
...
func (repo *ProjectGormRepository) ListByUserID(ctx context.Context, userID string, pagination *query.Pagination) ([]*project.Project, int64, error) {
	// Build base query
