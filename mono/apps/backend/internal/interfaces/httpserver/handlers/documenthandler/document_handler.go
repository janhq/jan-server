...
func (h *DocumentHandler) ScanDocument(ctx context.Context, userID string, req ScanDocumentRequest, authHeader string) (*ScanDocumentResponse, error) {
	startTime := time.Now()
	requestID := ""
...
func (h *DocumentHandler) GetDocumentContent(ctx context.Context, userID string, publicID string) (*ScanDocumentResponse, error) {
...
func (h *DocumentHandler) GetDocumentText(ctx context.Context, userID string, publicID string) (string, error) {
	doc, err := h.documentService.GetDocumentContentByPublicID(ctx, publicID)
	if err != nil {
...
func (h *DocumentHandler) ListDocuments(ctx context.Context, userID string, pagination *query.Pagination) (*DocumentListResponse, error) {
...
func (h *DocumentHandler) CreateProjectFile(ctx context.Context, userID string, projectPublicID string, req CreateProjectFileRequest, authHeader string) (*ProjectFileResponse, error) {
...
func (h *DocumentHandler) ListProjectFiles(ctx context.Context, userID string, projectPublicID string, pagination *query.Pagination) (*ProjectFileListResponse, error) {
	// Verify project ownership
	proj, err := h.projectService.GetProjectByPublicIDAndUserID(ctx, projectPublicID, userID)
	if err != nil {
		return nil, platformerrors.AsError(ctx, platformerrors.LayerHandler, err, "project not found")
...
func (h *DocumentHandler) GetProjectFile(ctx context.Context, userID string, projectPublicID, filePublicID string) (*ProjectFileResponse, error) {
	// Verify project ownership
	proj, err := h.projectService.GetProjectByPublicIDAndUserID(ctx, projectPublicID, userID)
	if err != nil {
		return nil, platformerrors.AsError(ctx, platformerrors.LayerHandler, err, "project not found")
...
func (h *DocumentHandler) DeleteProjectFile(ctx context.Context, userID string, projectPublicID, filePublicID string) error {
	// Verify project ownership
	proj, err := h.projectService.GetProjectByPublicIDAndUserID(ctx, projectPublicID, userID)
	if err != nil {
...
func (h *DocumentHandler) ReorderProjectFiles(ctx context.Context, userID string, projectPublicID string, req ReorderProjectFilesRequest) error {
	// Verify project ownership
	proj, err := h.projectService.GetProjectByPublicIDAndUserID(ctx, projectPublicID, userID)
	if err != nil {
		return platformerrors.AsError(ctx, platformerrors.LayerHandler, err, "project not found")
