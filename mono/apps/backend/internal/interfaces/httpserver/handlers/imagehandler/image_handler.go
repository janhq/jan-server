...
import (
	...
	imagerequest "jan-server/mono/apps/backend/internal/interfaces/httpserver/requests/image"
	imageresponse "jan-server/mono/apps/backend/internal/interfaces/httpserver/responses/image"
