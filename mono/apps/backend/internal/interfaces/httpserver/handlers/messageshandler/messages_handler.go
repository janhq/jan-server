...
import (
	...
	messagesrequests "jan-server/mono/apps/backend/internal/interfaces/httpserver/requests/messages"
	messagesresponses "jan-server/mono/apps/backend/internal/interfaces/httpserver/responses/messages"
...
func (h *MessagesHandler) CreateMessage(ctx context.Context, reqCtx *gin.Context, userID string, request messagesrequests.AnthropicMessagesRequest) error {
...
func (h *MessagesHandler) CountTokens(ctx context.Context, reqCtx *gin.Context, userID string, request messagesrequests.AnthropicCountTokensRequest) error {
	// Start OpenTelemetry span
