...
import (
	...
	domainmodel "jan-server/mono/apps/backend/internal/domain/model"
	...
	"jan-server/mono/apps/backend/internal/infrastructure/observability"
	conversationHandler "jan-server/mono/apps/backend/internal/interfaces/httpserver/handlers/conversationhandler"
	modelHandler "jan-server/mono/apps/backend/internal/interfaces/httpserver/handlers/modelhandler"
	chatrequests "jan-server/mono/apps/backend/internal/interfaces/httpserver/requests/chat"
	"jan-server/mono/apps/backend/internal/utils/httpclients/chat"
	"jan-server/mono/apps/backend/internal/utils/idgen"
	"jan-server/mono/apps/backend/internal/utils/platformerrors"
	"jan-server/mono/apps/backend/internal/utils/stringutils"
...
func (h *ChatHandler) getProjectContext(ctx context.Context, userID string, conv *conversation.Conversation) (string, *uint) {
...
func (h *ChatHandler) createConversationWithReferrer(ctx context.Context, userID string, referrer string) (*conversation.Conversation, error) {
...
func (h *ChatHandler) updateConversationTitleFromMessages(ctx context.Context, userID string, conv *conversation.Conversation, messages []openai.ChatCompletionMessage) *conversation.Conversation {
	if conv == nil {
		return nil
	}
...
func (h *ChatHandler) updateConversationTitleFromCompletion(ctx context.Context, userID string, conv *conversation.Conversation, messages []openai.ChatCompletionMessage, response *openai.ChatCompletionResponse) *conversation.Conversation {
...
func (h *ChatHandler) injectFileContent(ctx context.Context, userID string, messages []openai.ChatCompletionMessage) []openai.ChatCompletionMessage {
...
func (h *ChatHandler) getFileContentForInjection(ctx context.Context, userID string, url, filename, mimeType string) string {
