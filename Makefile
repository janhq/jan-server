...
config-generate:
	...
	@cd pkg/config && go generate ./...
	@echo " Configuration files generated:"
	@echo "  - config/defaults.yaml (auto-generated)"
	@echo "  - docs/configuration/config-schema.json (auto-generated)"
	@echo "  - docs/configuration/config-reference.md (auto-generated)"
...
config-drift-check:
	...
	@cd pkg/config && go generate ./... && git diff --exit-code config/defaults.yaml docs/configuration/
	@if [ $$? -eq 0 ]; then \
...
config-help:
	...
	@echo "  config-generate      Generate config files from Go structs (YAML, JSON schema, docs)"
	...
	@echo "  - docs/configuration/config-schema.json     JSON Schema for validation"
	@echo "  - docs/configuration/config-reference.md    Human-readable documentation"
	@echo ""
	@echo "Usage:"
