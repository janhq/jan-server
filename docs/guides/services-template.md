...
4. Register your handlers inside `internal/interfaces/httpserver`.
5. Add domain packages and migrations as needed.
6. Update root `.env.template`, README, and deployment manifests to include your service.
